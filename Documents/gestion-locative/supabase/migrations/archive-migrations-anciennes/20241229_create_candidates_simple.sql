-- ============================================================================
-- MIGRATION : Tables candidatures (VERSION SIMPLIFIÉE)
-- ============================================================================
-- Date: 2024-12-29
-- Description: Tables candidates pour architecture SANS entities
-- Prérequis: Tables properties, lots, users doivent exister
-- ============================================================================
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Politiques RLS: ~15 politiques (architecture SIMPLE)';
    RAISE NOTICE '';
    RAISE NOTICE '⚠️  Créer le bucket: candidate-documents (Storage → Private, 10MB)';
END $$;

              ...
              <button
                ...
                className={`p-6 border-2 rounded-xl text-left transition-all ${
                  viewMode === 'solution2'
                    ...
                    : 'border-[var(--border)] hover:border-emerald-400 hover:shadow-sm'
                }`}
              >
                <div className="flex items-start gap-4">
                  <div className={`p-3 rounded-xl ${
                    viewMode === 'solution2' ? 'bg-emerald-200 dark:bg-emerald-800/50' : 'bg-[var(--surface-elevated)]'
                  }`}>
                    <Grid className={`w-6 h-6 ${
                      viewMode === 'solution2' ? 'text-emerald-600 dark:text-emerald-400' : 'text-[var(--text-secondary)]'
                    }`} />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-display font-semibold text-[var(--text)] mb-1">

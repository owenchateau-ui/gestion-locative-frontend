      ...
      <div className="space-y-6">
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Card padding={true}>
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[var(--color-coral)]/10 rounded-xl">
                  <ArrowRight className="w-5 h-5 text-[var(--color-coral)] rotate-180" />
                </div>
                <div>
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-start gap-4">
                        <div className={`
                          p-3 rounded-xl
                          ${inventory.type === 'entry' ? 'bg-emerald-100 dark:bg-emerald-900/30' : 'bg-[var(--color-coral)]/10'}
                        `}>
                          <ClipboardList className={`
                            w-6 h-6
                            ${inventory.type === 'entry' ? 'text-emerald-600 dark:text-emerald-400' : 'text-[var(--color-coral)]'}
                          `} />
                        </div>

      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-start gap-3">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
            guarantee.guarantee_type === 'physical_person' ? 'bg-blue-100' :
            guarantee.guarantee_type === 'visale' ? 'bg-green-100' :
            guarantee.guarantee_type === 'gli' ? 'bg-purple-100' :
            'bg-gray-100'
          }`}>
            <Icon className={`w-5 h-5 ${
              guarantee.guarantee_type === 'physical_person' ? 'text-blue-600' :
              guarantee.guarantee_type === 'visale' ? 'text-green-600' :
              guarantee.guarantee_type === 'gli' ? 'text-purple-600' :
              'text-gray-600'
            }`} />
          </div>
